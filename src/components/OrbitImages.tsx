...
export default function OrbitImages({
  ...
  centerContent = null,
  responsive = false,
  progressOverride = undefined as any,
  radiusXOverride = undefined as any,
  radiusYOverride = undefined as any,
  itemSizeOverride = undefined as any,
  rotationOverride = undefined as any,
  translateXOverride = undefined as any,
  focusStrength = undefined as any,
}) {
  ...
  const items = images.map((src, index) => (
    <motion.img
      ...
      draggable={false}
      className="orbit-image shadow-[0_0_15px_rgba(0,255,255,0.6)]"
